...
public:
	...
	*/
    Client(std::shared_ptr<EQStreamInterface> c, ClientManager* manager);
	...
	*/
    ...
    void Handle_enteredWord(const char* data, unsigned int size);

    void Handle_updateWord(const char* data, unsigned int size);
	...
	*/
    ...
    void processAClientEnter(Client* other);

    void processClientUpdate(Client* other);

    void loadOtherClient(Client* other);
	/**
